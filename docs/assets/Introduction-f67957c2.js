import{j as n,a as o,F as a}from"./jsx-runtime-91a467a5.js";import{M as s}from"./index-b246aa41.js";import{u as i}from"./index-1d576ef5.js";import"./index-8db94870.js";import"./_commonjsHelpers-042e6b4d.js";import"./iframe-525147b3.js";import"../sb-preview/runtime.js";import"./index-17c6dcc8.js";import"./emotion-use-insertion-effect-with-fallbacks.browser.esm-ae8e40e8.js";import"./index-016bc981.js";import"./index-d37d4223.js";import"./setPrototypeOf-6f2f822b.js";import"./inheritsLoose-856773bf.js";import"./isNativeReflectConstruct-e378569d.js";import"./index-c41dfe6e.js";import"./_baseIsEqual-e0960ee2.js";import"./index-356e4a49.js";function r(t){const e=Object.assign({p:"p",code:"code",a:"a",strong:"strong",img:"img",hr:"hr",h2:"h2",em:"em",ol:"ol",li:"li",ul:"ul",pre:"pre"},i(),t.components);return o(a,{children:[n(s,{title:"Introduction"}),`
...
`,n(e.p,{children:n(e.em,{children:"Disclaimer: This addon only supports Typescript projects with React and is designed for Storybook 7. It may not work properly in other environments."})}),`
...
`})}),`
`,o(e.p,{children:["3.(optional) Define config for your component in ",n(e.code,{children:".stories/your-component.stories.tsx"}),". Following by type ",n(e.code,{children:"PermutationMeta"})," will make this step easy"]}),`
`,n(e.pre,{children:n(e.code,{className:"language-typescript",children:`// stories/Component.stories.(ts|tsx)

import React from "react";
import { PermutationMeta } from "sb-addon-permutation-table"; // Not necessary, but it will help you to define the type of meta
...
const meta: PermutationMeta<typeof YourComponent> = {
  ...
  parameters: {
    permutation: {
      componentName: "Takahashi", // Now "Takahashi" will be shown in the panel, regardless of the component name
      importPath: "@yourLib/yourComponent", // The value copied when you click the "Copy import" button
      children: "<div>Chef of the diamond city</div>", // A value passed to children
      deactivate: ["foo", "bar"], // Deactivate property foo, bar
    },
  },
};
`})}),`
...
`,n(e.p,{children:"MIT"})]})}function T(t={}){const{wrapper:e}=Object.assign({},i(),t.components);return e?n(e,Object.assign({},t,{children:n(r,t)})):r(t)}export{T as default};
//# sourceMappingURL=Introduction-f67957c2.js.map
